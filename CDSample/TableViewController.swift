...
class TableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // Si necesitamos establecer un criterio de búsqueda, usamos NSPredicate
        
        // EJemplos de uso
        // SELECT * FROM Persona WHERE apellidos = 'Aguilar'
        //let elFiltro = NSPredicate(format:"apellidos = %@", "Aguilar")
        // let elFiltro = NSPredicate(format:"apellidos <> %@", "Aguilar")
        //let elFiltro = NSPredicate(format:"apellidos BEGINSWITH[c] %@", "A")
